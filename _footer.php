	<div class="col-md-3 panel" style="margin-top: 1em; background-color: #5599FF; box-shadow: 3px 5px 5px #888888;">
...
<footer class="panel-footer text-center" style="margin-top: 2em;">
	<p>Copyright &copy; <?php echo date('Y'); ?> SDN Pamulang Permai, Tangerang Selatan</p>
</footer>
